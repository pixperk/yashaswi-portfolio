...
export default function CLI({
    ...
    switch (trimmedCommand.toLowerCase()) {
      case "help":
        newOutput.push(
          ...
          "  latest_project - Show latest project",
      ...
      case "contact":
        ...
        break;
      case "latest_project":
        newOutput.push(`${projects[0].title} - ${projects[0].description}`);
      ...
      default:
        newOutput.push(
          `Command not recognized: ${trimmedCommand}. Type 'help' for a list of available commands.`
        );
    }
  ...
  return (
    <motion.div
      ...
      className={`${
        theme === "retro"
          ? "bg-gray-900 border-green-400 font-mono"
          : "bg-gray-800 border-orange-400 font-sans"
      } border-2 rounded-lg p-4 text-sm h-[calc(100vh-8rem)] flex flex-col`}
      role="application"
